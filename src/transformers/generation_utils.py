    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        ...
        if "encoder_outputs" not in model_kwargs:
            ...
            model_kwargs["encoder_outputs"] = BaseModelOutput(
                ...
                hidden_states=model_kwargs["encoder_outputs"][1] if len(model_kwargs["encoder_outputs"]) > 1 else None,
                attentions=model_kwargs["encoder_outputs"][2] if len(model_kwargs["encoder_outputs"]) > 2 else None,
            )
        return model_kwargs
        ...
        **model_kwargs,
        ...
        while cur_len < max_length:
            ...
            if cur_len == begin_len:  #if no strategy token, set False
                ...
                elif 54945<next_token_logits.size()[1]<54955:
